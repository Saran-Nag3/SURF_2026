...
def build_user_prompt(
    ...
    pexels_section = build_pexels_prompt_section(pexels_images or [])
    return (
        f"SCREEN TO DESIGN\n"
...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmp_str:
        ...
        print(f"    -> {len(csv_rows)} screen row(s) detected")
        ...
        print(f"    -> Will contain CompanyName/screen_type.svg per screen, plus "
        ...
        for i, row in enumerate(csv_rows, 1):
            ...
            cache_key = compute_cache_key(
                ...
                design_doc, pexels_images, args.provider, args.model,
            )
            ...
            if cached is not None:
                ...
                out_file = out_company_dir / f"{safe_screen_name}.svg"
            ...
            for attempt in range(args.max_retries):
                try:
                    ...
                    svg_clean = clean_svg_output(raw_output)
