...
OAI_COMPAT_API_KEY  = os.environ.get("OPENROUTER_API_KEY", "")   # set OPENROUTER_API_KEY env var
OAI_COMPAT_MODEL    = "google/gemma-4-31b-it"   # use ":free" suffix for the no-cost tier
