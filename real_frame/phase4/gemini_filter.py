...
OAI_COMPAT_MODEL    = "google/gemini-2.5-flash"   # Gemini vision via OpenRouter; newer: google/gemini-3.6-flash. Verify at openrouter.ai/models?q=gemini
...
class VisionVerifier:
    def __init__(self, cache_dir=".vision_cache_gemini"):
...
def main():
    ...
    ap.add_argument("-o", "--output", default="Real_Screens_gemini", help="output folder name")
